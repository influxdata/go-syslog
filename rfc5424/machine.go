...
func (m *machine) Parse(input []byte) (syslog.Message, error) {
	...
	stCase604:
		...
		case _widec < 512:
			switch {
			case _widec < 450:
				if 256 <= _widec && _widec <= 383 {
					goto tr632
				}
			case _widec > 479:
				switch {
				case _widec > 495:
					if 497 <= _widec && _widec <= 499 {
						goto tr638
					}
				case _widec >= 481:
					goto tr635
	...
	stCase608:
		...
		switch {
		case _widec < 512:
			if 384 <= _widec && _widec <= 447 {
				goto st605
			}
		case _widec > 639:
			switch {
			case _widec > 703:
				if 704 <= _widec && _widec <= 767 {
					goto st607
				}
			case _widec >= 640:
				goto st606
	...
	stCase611:
		...
		switch {
		case _widec < 512:
			if 384 <= _widec && _widec <= 415 {
				goto st17
			}
		case _widec > 639:
			switch {
			case _widec > 671:
				if 672 <= _widec && _widec <= 767 {
					goto st607
				}
			case _widec >= 640:
				goto st608
	...
	stCase614:
		...
		switch {
		case _widec < 512:
			if 384 <= _widec && _widec <= 399 {
				goto st19
			}
		case _widec > 639:
			switch {
			case _widec > 655:
				if 656 <= _widec && _widec <= 767 {
					goto st607
				}
			case _widec >= 640:
				goto st610
	...
	_testEof:
		...
		if (m.p) == (m.eof) {
			switch m.cs {
			case 605, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615, 616:
