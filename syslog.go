...
func (c *current) onPri1(value interface{}) (interface{}, error) {
	return value, nil
}

func (p *parser) callonPri1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onPri1(stack["value"])
}
...
func (p *parser) callonPrival5() (bool, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onPrival5(stack["values"])
}
